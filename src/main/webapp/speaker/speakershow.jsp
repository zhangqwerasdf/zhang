     ...
     <!--    <tr>
        ...
        <c:forEach begin="0" end="${list.size()-1}" var="i">
            <tr>
              <td><input type="checkbox"></td>
		      <td>${list[i].id}</td>
		      <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis">${list[i].speaker_job}</td>
		      <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis">${list[i].speaker_desc}</td>
		      <td><a href="">✎</a></td>
		      <td><a href="">X</a></td>
            </tr>
