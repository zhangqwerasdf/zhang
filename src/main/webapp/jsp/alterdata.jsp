                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                                <img src="http://localhost:8080/SSMVideo/speakerimg/3.jpg" width="200px;">
                        </div>
                        <div class="profile_ifo_area">
                           <form action="userUpdate">
                                ...
                                <div class="form_group">
                                    ...
                                    <input id="man"  type="radio" value="男"><label for="man">男</label>
                                    <input id="woman" type="radio" value="女"><label for="woman">女</label>
                                ...
                                <div class="form_group">
                                    ...
                                    <span><input name="accounts" type="hidden" value="${user.accounts}">${user.accounts}</span>
                                </div>
                                <div class="form_group">
...
<footer>
	<div class="container">
		<ul>
			<li><img src="http://localhost:8080/SSMVideo/z/logo.png" alt="" id="foot_logo"></li>
...
<script src="http://localhost:8080/SSMVideo/z/jquery-1.js"></script>
<script src="http://localhost:8080/SSMVideo/z/gVerify.js"></script>
<script src="http://localhost:8080/SSMVideo/z/index.js"></script>
