        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="jsp/alterdata.jsp">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="jsp/alterimg.jsp">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="jsp/alterpassword.jsp">密码安全</a></li>
                </ul>
                ...
                <div class="proflle_tab_body">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
		                         <img id="avatar" width="200px;" src="../z/avatar.png" alt="">
                            <p>  欢迎回来！</p>
                        </div>
